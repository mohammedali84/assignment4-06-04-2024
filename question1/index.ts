...
else {console.log("Not Eligible for votting")}

//Instructions: Assign a grade based on a numerical score.//

let student=32
if(student>=85 && student<=100){console.log( "Student achieved A grade" )}
else if(student>=80 && student<=84){console.log("Studend achieved B grade")}
else if (student>=70 && student<=79){console.log("Student achieved C grade")}
else if (student>=60 && student<=69){console.log("Student achieved D grade")}
else if (student >=33 && student<=59){console.log("Student achieved E grade")}
else if (student>=1 && student <=32){console.log("Student is Fail")}
else{console.log("Invalid Marks, Please Enter correct Marks")};
...
// Instructions: Find the maximum of three numbers//
    ...
    let leap_year=2001;
if(leap_year%4==0){console.log("It's Leap Year",leap_year)}
else{console.log("non-leap year",leap_year)}
...
let number1= 0;
if(number1>0){console.log("Number is Positive",number1)}
else if (number1<0){console.log("Number is Negitive",number1)}
else{console.log("Nunber is Zero",number1)}
